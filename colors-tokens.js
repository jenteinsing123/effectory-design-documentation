/* AUTO-GENERATED — run build-tokens.py to regenerate */
(function () {
  var T = {
    'bg/accent/blue/base': { lc:{hex:'#205bb9',prim:'color/blue/800'}, lp:{hex:'#205bb9',prim:'color/blue/800'}, dc:{hex:'#acceff',prim:'color/blue/300'} },
    'bg/accent/blue/subtle': { lc:{hex:'#d6e6ff',prim:'color/blue/200'}, lp:{hex:'#d6e6ff',prim:'color/blue/200'}, dc:{hex:'#19417f',prim:'color/blue/900'} },
    'bg/accent/green/base': { lc:{hex:'#236e41',prim:'color/green/800'}, lp:{hex:'#236e41',prim:'color/green/800'}, dc:{hex:'#94dfa8',prim:'color/green/300'} },
    'bg/accent/green/subtle': { lc:{hex:'#bdf4cc',prim:'color/green/200'}, lp:{hex:'#bdf4cc',prim:'color/green/200'}, dc:{hex:'#174b22',prim:'color/green/900'} },
    'bg/accent/orange/base': { lc:{hex:'#a83e00',prim:'color/orange/800'}, lp:{hex:'#a83e00',prim:'color/orange/800'}, dc:{hex:'#fec095',prim:'color/orange/300'} },
    'bg/accent/orange/subtle': { lc:{hex:'#ffdfc9',prim:'color/orange/200'}, lp:{hex:'#ffdfc9',prim:'color/orange/200'}, dc:{hex:'#702d09',prim:'color/orange/900'} },
    'bg/accent/purple/base': { lc:{hex:'#a91ba9',prim:'color/purple (new)/800'}, lp:{hex:'#a91ba9',prim:'color/purple (new)/800'}, dc:{hex:'#ffacff',prim:'color/purple (new)/300'} },
    'bg/accent/purple/subtle': { lc:{hex:'#ffd6ff',prim:'color/purple (new)/200'}, lp:{hex:'#ffd6ff',prim:'color/purple (new)/200'}, dc:{hex:'#7f197f',prim:'color/purple (new)/900'} },
    'bg/accent/red/base': { lc:{hex:'#b9252a',prim:'color/red/800'}, lp:{hex:'#b9252a',prim:'color/red/800'}, dc:{hex:'#feb9b9',prim:'color/red/300'} },
    'bg/accent/red/subtle': { lc:{hex:'#ffdbdb',prim:'color/red/200'}, lp:{hex:'#ffdbdb',prim:'color/red/200'}, dc:{hex:'#860e12',prim:'color/red/900'} },
    'bg/accent/turquoise/base': { lc:{hex:'#166764',prim:'color/turqouise/800'}, lp:{hex:'#166764',prim:'color/turqouise/800'}, dc:{hex:'#7adddb',prim:'color/turqouise/300'} },
    'bg/accent/turquoise/subtle': { lc:{hex:'#b6f2f1',prim:'color/turqouise/200'}, lp:{hex:'#b6f2f1',prim:'color/turqouise/200'}, dc:{hex:'#0e4846',prim:'color/turqouise/900'} },
    'bg/accent/yellow/base': { lc:{hex:'#8a4b15',prim:'color/yellow/800'}, lp:{hex:'#8a4b15',prim:'color/yellow/800'}, dc:{hex:'#fecd29',prim:'color/yellow/300'} },
    'bg/accent/yellow/subtle': { lc:{hex:'#ffe488',prim:'color/yellow/200'}, lp:{hex:'#ffe488',prim:'color/yellow/200'}, dc:{hex:'#6b310a',prim:'color/yellow/900'} },
    ...
    'bg/brand/base': { lc:{hex:'#0a9d99',prim:'color/turqouise/600'}, lp:{hex:'#fecd29',prim:'color/yellow/300'}, dc:{hex:'#0a9d99',prim:'color/turqouise/600'} },
    'bg/brand/base-hover': { lc:{hex:'#0c827f',prim:'color/turqouise/700'}, lp:{hex:'#fdbd12',prim:'color/yellow/400'}, dc:{hex:'#30b3af',prim:'color/turqouise/500'} },
    'bg/brand/base-pressed': { lc:{hex:'#166764',prim:'color/turqouise/800'}, lp:{hex:'#ec9f06',prim:'color/yellow/500'}, dc:{hex:'#5acbc7',prim:'color/turqouise/400'} },
    'bg/brand/subtle': { lc:{hex:'#d2f8f6',prim:'color/turqouise/100'}, lp:{hex:'#ffe488',prim:'color/yellow/200'}, dc:{hex:'#166764',prim:'color/turqouise/800'} },
    'bg/brand/subtle-selected': { lc:{hex:'#d2f8f6',prim:'color/turqouise/100'}, lp:{hex:'#ffefc2',prim:'color/yellow/100'}, dc:{hex:'#454d5f',prim:'color/neutral/dark/400'} },
    ...
    'bg/info/base': { lc:{hex:'#3174db',prim:'color/blue/700'}, lp:{hex:'#3174db',prim:'color/blue/700'}, dc:{hex:'#4c8ef2',prim:'color/blue/600 (500)'} },
    ...
    'bg/input-pressed': { lc:{hex:'#f1f2f4',prim:'color/neutral/200'}, lp:{hex:'#f1f2f4',prim:'color/neutral/200'}, dc:{hex:'#4d576a',prim:'color/neutral/dark/500'} },
    'bg/interface/body': { lc:{hex:'#ffffff',prim:'color/neutral/0 - White'}, lp:{hex:'#ffffff',prim:'color/neutral/0 - White'}, dc:{hex:'#151b26',prim:'color/neutral/dark/0'} },
    'bg/interface/body-secondary': { lc:{hex:'#f8f8f9',prim:'color/neutral/100'}, lp:{hex:'#f8f8f9',prim:'color/neutral/100'}, dc:{hex:'#151b26',prim:'color/neutral/dark/0'} },
    'bg/interface/breadcrumbs': { lc:{hex:'#ffffff',prim:'color/neutral/0 - White'}, lp:{hex:'#ffffff',prim:'color/neutral/0 - White'}, dc:{hex:'#232a39',prim:'color/neutral/dark/200'} },
    'bg/interface/main-menu': { lc:{hex:'#ffffff',prim:'color/neutral/0 - White'}, lp:{hex:'#ffffff',prim:'color/neutral/0 - White'}, dc:{hex:'#232a39',prim:'color/neutral/dark/200'} },
    ...
    'bg/results/benchmark': { lc:{hex:'#0a9d99',prim:'color/turqouise/600'}, lp:{hex:'#0a9d99',prim:'color/turqouise/600'}, dc:{hex:'#0a9d99',prim:'color/turqouise/600'} },
    'bg/results/current': { lc:{hex:'#4c8ef2',prim:'color/blue/600 (500)'}, lp:{hex:'#4c8ef2',prim:'color/blue/600 (500)'}, dc:{hex:'#4c8ef2',prim:'color/blue/600 (500)'} },
    ...
    'bg/trasnsparent': { lc:{hex:'rgba(25, 39, 67, 0.00)',prim:'color/neutral/alpha-0'}, lp:{hex:'rgba(25, 39, 67, 0.00)',prim:'color/neutral/alpha-0'}, dc:{hex:'rgba(25, 39, 67, 0.00)',prim:'color/neutral/alpha-0'} },
    ...
    'border/accent/blue/base': { lc:{hex:'#205bb9',prim:'color/blue/800'}, lp:{hex:'#205bb9',prim:'color/blue/800'}, dc:{hex:'#d6e6ff',prim:'color/blue/200'} },
    'border/accent/blue/inverse': { lc:{hex:'#d6e6ff',prim:'color/blue/200'}, lp:{hex:'#d6e6ff',prim:'color/blue/200'}, dc:{hex:'#19417f',prim:'color/blue/900'} },
    'border/accent/green/base': { lc:{hex:'#236e41',prim:'color/green/800'}, lp:{hex:'#236e41',prim:'color/green/800'}, dc:{hex:'#bdf4cc',prim:'color/green/200'} },
    'border/accent/green/inverse': { lc:{hex:'#bdf4cc',prim:'color/green/200'}, lp:{hex:'#bdf4cc',prim:'color/green/200'}, dc:{hex:'#174b22',prim:'color/green/900'} },
    'border/accent/orange/base': { lc:{hex:'#a83e00',prim:'color/orange/800'}, lp:{hex:'#a83e00',prim:'color/orange/800'}, dc:{hex:'#ffdfc9',prim:'color/orange/200'} },
    'border/accent/orange/inverse': { lc:{hex:'#ffdfc9',prim:'color/orange/200'}, lp:{hex:'#ffdfc9',prim:'color/orange/200'}, dc:{hex:'#702d09',prim:'color/orange/900'} },
    'border/accent/purple/base': { lc:{hex:'#a91ba9',prim:'color/purple (new)/800'}, lp:{hex:'#a91ba9',prim:'color/purple (new)/800'}, dc:{hex:'#ffd6ff',prim:'color/purple (new)/200'} },
    'border/accent/purple/inverse': { lc:{hex:'#ffd6ff',prim:'color/purple (new)/200'}, lp:{hex:'#ffd6ff',prim:'color/purple (new)/200'}, dc:{hex:'#7f197f',prim:'color/purple (new)/900'} },
    'border/accent/red/base': { lc:{hex:'#b9252a',prim:'color/red/800'}, lp:{hex:'#b9252a',prim:'color/red/800'}, dc:{hex:'#ffdbdb',prim:'color/red/200'} },
    'border/accent/red/inverse': { lc:{hex:'#ffdbdb',prim:'color/red/200'}, lp:{hex:'#ffdbdb',prim:'color/red/200'}, dc:{hex:'#860e12',prim:'color/red/900'} },
    'border/accent/turquoise/base': { lc:{hex:'#166764',prim:'color/turqouise/800'}, lp:{hex:'#166764',prim:'color/turqouise/800'}, dc:{hex:'#b6f2f1',prim:'color/turqouise/200'} },
    'border/accent/turquoise/inverse': { lc:{hex:'#b6f2f1',prim:'color/turqouise/200'}, lp:{hex:'#b6f2f1',prim:'color/turqouise/200'}, dc:{hex:'#0e4846',prim:'color/turqouise/900'} },
    'border/accent/yellow/baes': { lc:{hex:'#8a4b15',prim:'color/yellow/800'}, lp:{hex:'#8a4b15',prim:'color/yellow/800'}, dc:{hex:'#ffe488',prim:'color/yellow/200'} },
    'border/accent/yellow/inverse': { lc:{hex:'#ffe488',prim:'color/yellow/200'}, lp:{hex:'#ffe488',prim:'color/yellow/200'}, dc:{hex:'#6b310a',prim:'color/yellow/900'} },
    ...
    'border/brand/base': { lc:{hex:'#0c827f',prim:'color/turqouise/700'}, lp:{hex:'#d68100',prim:'color/yellow/600'}, dc:{hex:'#5acbc7',prim:'color/turqouise/400'} },
    'border/brand/base-hover': { lc:{hex:'#166764',prim:'color/turqouise/800'}, lp:{hex:'#b16107',prim:'color/yellow/700'}, dc:{hex:'#7adddb',prim:'color/turqouise/300'} },
    'border/brand/base-pressed': { lc:{hex:'#0e4846',prim:'color/turqouise/900'}, lp:{hex:'#8a4b15',prim:'color/yellow/800'}, dc:{hex:'#b6f2f1',prim:'color/turqouise/200'} },
    'border/brand/secondary': { lc:{hex:'#0a9d99',prim:'color/turqouise/600'}, lp:{hex:'#ec9f06',prim:'color/yellow/500'}, dc:{hex:'#30b3af',prim:'color/turqouise/500'} },
    'border/brand/subtle': { lc:{hex:'#7adddb',prim:'color/turqouise/300'}, lp:{hex:'#fdbd12',prim:'color/yellow/400'}, dc:{hex:'#166764',prim:'color/turqouise/800'} },
    ...
    'border/highlight/base-hover': { lc:{hex:'#b16107',prim:'color/yellow/700'}, lp:{hex:'#b16107',prim:'color/yellow/700'}, dc:{hex:'#ffe488',prim:'color/yellow/200'} },
    ...
    'border/info/base-hover': { lc:{hex:'#205bb9',prim:'color/blue/800'}, lp:{hex:'#205bb9',prim:'color/blue/800'}, dc:{hex:'#4c8ef2',prim:'color/blue/600 (500)'} },
    ...
    'border/negative/base-hover': { lc:{hex:'#860e12',prim:'color/red/900'}, lp:{hex:'#860e12',prim:'color/red/900'}, dc:{hex:'#fe7377',prim:'color/red/500'} },
    'border/negative/base-pressed': { lc:{hex:'#63060a',prim:'color/red/1000'}, lp:{hex:'#63060a',prim:'color/red/1000'}, dc:{hex:'#fe9c9c',prim:'color/red/400'} },
    ...
    'border/positive/base-hover': { lc:{hex:'#278747',prim:'color/green/700'}, lp:{hex:'#278747',prim:'color/green/700'}, dc:{hex:'#72ce90',prim:'color/green/400'} },
    ...
    'border/warning/base-hover': { lc:{hex:'#c75000',prim:'color/orange/700'}, lp:{hex:'#c75000',prim:'color/orange/700'}, dc:{hex:'#fda569',prim:'color/orange/400'} },
    ...
    'content/accent/blue/base': { lc:{hex:'#205bb9',prim:'color/blue/800'}, lp:{hex:'#205bb9',prim:'color/blue/800'}, dc:{hex:'#acceff',prim:'color/blue/300'} },
    'content/accent/blue/subtle': { lc:{hex:'#d6e6ff',prim:'color/blue/200'}, lp:{hex:'#d6e6ff',prim:'color/blue/200'}, dc:{hex:'#19417f',prim:'color/blue/900'} },
    'content/accent/green/base': { lc:{hex:'#236e41',prim:'color/green/800'}, lp:{hex:'#236e41',prim:'color/green/800'}, dc:{hex:'#94dfa8',prim:'color/green/300'} },
    'content/accent/green/subtle': { lc:{hex:'#bdf4cc',prim:'color/green/200'}, lp:{hex:'#bdf4cc',prim:'color/green/200'}, dc:{hex:'#174b22',prim:'color/green/900'} },
    'content/accent/orange/base': { lc:{hex:'#a83e00',prim:'color/orange/800'}, lp:{hex:'#a83e00',prim:'color/orange/800'}, dc:{hex:'#fec095',prim:'color/orange/300'} },
    'content/accent/orange/subtle': { lc:{hex:'#ffdfc9',prim:'color/orange/200'}, lp:{hex:'#ffdfc9',prim:'color/orange/200'}, dc:{hex:'#702d09',prim:'color/orange/900'} },
    'content/accent/red/base': { lc:{hex:'#b9252a',prim:'color/red/800'}, lp:{hex:'#b9252a',prim:'color/red/800'}, dc:{hex:'#feb9b9',prim:'color/red/300'} },
    'content/accent/red/subtle': { lc:{hex:'#ffdbdb',prim:'color/red/200'}, lp:{hex:'#ffdbdb',prim:'color/red/200'}, dc:{hex:'#860e12',prim:'color/red/900'} },
    'content/accent/turquoise/base': { lc:{hex:'#166764',prim:'color/turqouise/800'}, lp:{hex:'#166764',prim:'color/turqouise/800'}, dc:{hex:'#7adddb',prim:'color/turqouise/300'} },
    'content/accent/turquoise/subtle': { lc:{hex:'#b6f2f1',prim:'color/turqouise/200'}, lp:{hex:'#b6f2f1',prim:'color/turqouise/200'}, dc:{hex:'#0e4846',prim:'color/turqouise/900'} },
    'content/accent/yellow/base': { lc:{hex:'#8a4b15',prim:'color/yellow/800'}, lp:{hex:'#8a4b15',prim:'color/yellow/800'}, dc:{hex:'#fecd29',prim:'color/yellow/300'} },
    'content/accent/yellow/subtle': { lc:{hex:'#ffe488',prim:'color/yellow/200'}, lp:{hex:'#ffe488',prim:'color/yellow/200'}, dc:{hex:'#6b310a',prim:'color/yellow/900'} },
    ...
    'content/action-pressed': { lc:{hex:'rgba(25, 39, 67, 0.95)',prim:'color/neutral/alpha-95'}, lp:{hex:'#192743',prim:'color/neutral/1200'}, dc:{hex:'rgba(255, 255, 255, 0.95)',prim:'color/neutral/dark/alpha-95'} },
    ...
    'content/brand/base': { lc:{hex:'#166764',prim:'color/turqouise/800'}, lp:{hex:'#8a4b15',prim:'color/yellow/800'}, dc:{hex:'#7adddb',prim:'color/turqouise/300'} },
    'content/brand/secondary': { lc:{hex:'#0c827f',prim:'color/turqouise/700'}, lp:{hex:'#b16107',prim:'color/yellow/700'}, dc:{hex:'#5acbc7',prim:'color/turqouise/400'} },
    ...
    'content/highlight/secondary-hover': { lc:{hex:'#d68100',prim:'color/yellow/600'}, lp:{hex:'#d68100',prim:'color/yellow/600'}, dc:{hex:'#fdbd12',prim:'color/yellow/400'} },
    ...
    'content/info/secondary-hover': { lc:{hex:'#205bb9',prim:'color/blue/800'}, lp:{hex:'#205bb9',prim:'color/blue/800'}, dc:{hex:'#acceff',prim:'color/blue/300'} },
    ...
    'content/negative/secondary-hover': { lc:{hex:'#b9252a',prim:'color/red/800'}, lp:{hex:'#b9252a',prim:'color/red/800'}, dc:{hex:'#feb9b9',prim:'color/red/300'} },
    ...
    'content/placeholder': { lc:{hex:'rgba(25, 39, 67, 0.67)',prim:'color/neutral/alpha-65'}, lp:{hex:'rgba(25, 39, 67, 0.67)',prim:'color/neutral/alpha-65'}, dc:{hex:'rgba(255, 255, 255, 0.67)',prim:'color/neutral/dark/alpha-65'} },
    ...
    'content/positive/secondary-hover': { lc:{hex:'#236e41',prim:'color/green/800'}, lp:{hex:'#236e41',prim:'color/green/800'}, dc:{hex:'#94dfa8',prim:'color/green/300'} },
    ...
    'content/warning/secondary-hover': { lc:{hex:'#a83e00',prim:'color/orange/800'}, lp:{hex:'#a83e00',prim:'color/orange/800'}, dc:{hex:'#fec095',prim:'color/orange/300'} },
    'logo/bg': { lc:{hex:'#30b3af',prim:'color/turqouise/500'}, lp:{hex:'#fdbd12',prim:'color/yellow/400'}, dc:{hex:'#30b3af',prim:'color/turqouise/500'} },
    'logo/content': { lc:{hex:'#ffffff',prim:'color/neutral/0 - White'}, lp:{hex:'#192743',prim:'color/neutral/1200'}, dc:{hex:'#ffffff',prim:'color/neutral/0 - White'} },
  };
